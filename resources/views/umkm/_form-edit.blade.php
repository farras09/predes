...
<script>
    $(document).ready(function() {
        ...
        function dynamic_field(number) {
            ...
            html += '<div class="form-group"><label for="email"> Alamat </label>{!! Form::textarea("alamat", null, ["class" => $errors-> has("alamat") ? "form-control is-invalid" : "form-control", "required"]) !!}@if($errors->has("alamat")) <span class = "invalid-feedback" ><strong> {{$errors->first("alamat")}}</strong></span>@endif</div></div>';
            // if (number > 1) {
